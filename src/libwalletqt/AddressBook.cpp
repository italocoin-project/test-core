...
AddressBook::AddressBook(Italocoin::AddressBook *abImpl,QObject *parent)
...
QList<Italocoin::AddressBookRow*> AddressBook::getAll(bool update) const
{
    qDebug(__FUNCTION__);
...
Italocoin::AddressBookRow * AddressBook::getRow(int index) const
{
